...
func addBinary(a string, b string) string {
	/*
		...
		в результрующую строку вводим остаток от деления этой суммы на 2
		В аккумулятор пойдет 1
		...
		Дальше мы итерируемся по этому хвосту, пока аккумулятор > 0 или в строке
		еще есть элементы
